...
export default function TimeIsMoney() {
  const post =
    <div className={styles.postContent}>
      <p><span className={styles.lead}>U</span>ntil recently, I have been heavily under the mentality that saving money is the most important thing. I mean, don&#39;t get me wrong, I was blessed enough during my childhood to be provided for by my parents. So any money I did make, I was able to spend on my wants, and so I did just that over the years.</p>
