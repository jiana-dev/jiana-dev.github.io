...
export const meta = {
  title: "How to Plan Your Goals Using Scrum",
  subtitle: "Tech Translation",
  preview: "The goal of this post is to give you an idea for a structured way to organize your goals using concepts borrowed from software development processes.",
  date: "2020-11-08T18:13:50.417-07:00",
  readTime: "6 min read",
  imageFolder: "scrum_goal_planning"
}
...
<div className={styles.postContent}>
  ...
  <ol>
    <li><p>Choose how you will measure your time and effort. This will be your <strong>estimation</strong> measurement. In our case, we will use the <strong>Pomodoro Technique</strong> like a <strong>timebox</strong> you give yourself to measure task completion.</p>
      <div className={styles.imgHolder}>
        <ImageWithCaption src="../images/scrum_goal_planning/estimation.png" alt="estimation"/>
      </div>
    </li>
    <li><p>Identify and dump your goals and ideas into your <strong>Backlog</strong> (this is intended to be an ongoing process everytime you think of something new)</p>
      <div className={styles.imgHolder}>
        <ImageWithCaption src="../images/scrum_goal_planning/backlog 1.png" alt="backlog"/>
      </div>
    </li>
  </ol>
  ...
  <ol start='3'>
    ...
    <div className={styles.imgHolder}>
      <ImageWithCaption src="../images/scrum_goal_planning/backlog 2.png" alt="backlog"/>
    </div>
    ...
    <div className={styles.imgHolder}>
      <ImageWithCaption src="../images/scrum_goal_planning/backlog 3.png" alt="backlog"/>
    </div>
    ...
    <div className={styles.imgHolder}>
      <ImageWithCaption src="../images/scrum_goal_planning/backlog 4.png" alt="backlog"/>
    </div>
    ...
    <div className={styles.imgHolder}>
      <ImageWithCaption src="../images/scrum_goal_planning/backlog 5.png" alt="backlog"/>
    </div>
    ...
    <div className={styles.imgHolder}>
      <ImageWithCaption src="../images/scrum_goal_planning/requirements.png" alt="requirements"/>
    </div>
    <li><strong>Estimate</strong> your Small goals in the measurement above using the Step 0 measurement.</li>
    <div className={styles.imgHolder}>
      <ImageWithCaption src="../images/scrum_goal_planning/working backlog.png" alt="working backlog"/>
    </div>
  </ol>
  ...
  <ol start='9'>
    ...
    <div className={styles.imgHolder}>
      <ImageWithCaption src="../images/scrum_goal_planning/sprint timeline.png" alt="sprint timeline"/>
    </div>
    ...
    <div className={styles.imgHolder}>
      <ImageWithCaption src="../images/scrum_goal_planning/dragdrop.gif" alt="dragdrop"/>
    </div>
